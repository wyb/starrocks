...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/alter/RollupJob.java
    ...
    public boolean sendTasks() {
        ...
        try {
            synchronized (this) {
                ...
                // in starrocks 3.2, the rollup keys type is not serialized, when a fe follower change to fe master
