    ...
    public boolean cancel(DeleteHandler.CancelType cancelType, String reason) {
        ...
        try {
            ...
            TransactionState state =
                    globalTransactionMgr.getTransactionState(getDeleteInfo().getDbId(), getTransactionId());
            if (state == null) {
                LOG.warn("cancel delete job failed because txn not found, transactionId: {}", getTransactionId());
