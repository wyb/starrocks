        ...
        try {
            ...
            if (request.getTask_status().getStatus_code() != TStatusCode.OK) {
                ...
                if (request.isSetFinish_tablet_infos()) {
                    ...
                    TabletMeta tabletMeta = invertedIndex.getTabletMeta(createReplicaTask.getTabletId());
                    if (!tabletMeta.useCloudStorage()) {
                        Replica replica = invertedIndex.getReplica(tabletId, createReplicaTask.getBackendId());
