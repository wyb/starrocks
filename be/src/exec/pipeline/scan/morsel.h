...
public:
    ...
    virtual void set_tablets(const std::vector<BaseTabletSharedPtr>& tablets) {}
...
public:
    ...
    void set_tablets(const std::vector<BaseTabletSharedPtr>& tablets) override { _tablets = tablets; }
