...
VerticalGeneralTabletWriter::VerticalGeneralTabletWriter(std::shared_ptr<const TabletSchema> tschema, Tablet tablet,
                                                         uint32_t max_rows_per_segment)
        : TabletWriter(std::move(tschema)), _tablet(tablet), _max_rows_per_segment(max_rows_per_segment) {}
